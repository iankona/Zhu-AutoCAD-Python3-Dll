...
namespace ZhuACADPlugin
{
    public class HelloWorld
    {
        ...
        public void 函数1()
        {
            ...
            Runtime.PythonDLL = "F:\\CADdll\\python-3.13.11-embed-amd64\\python313.dll";
            PythonEngine.Initialize();
            using (Py.GIL())
            {
                dynamic sys = Py.Import("sys");
                sys.path.append("F:\\CADdll\\pythonscripts");
                sys.path.append("F:\\CADdll\\pythonscripts\\libs");
                sys.path.append("F:\\CADdll\\pythonscripts\\functions");
